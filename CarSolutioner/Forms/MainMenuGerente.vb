Public Class MainMenuGerente
    Dim conexion As ConnectionBD = Login.conexion
    Private Sub MainMenu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblusuarioact.Text = "Usuario Actual: Gerente"
    ...
    Private Sub tbpEmpleados_Click(sender As Object, e As EventArgs) Handles tbpEmpleados.Click

    End Sub

    Private Sub lblusuarioact_Click(sender As Object, e As EventArgs) Handles lblusuarioact.Click
