Public Class MainMenuInvitado
    ...
    Private Sub Sidebar_Click(sender As Object, e As EventArgs) Handles btnVehiculos.Click, pbxVehiculo.Click
    ...
    Private Sub dtvVehi_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dtvVehi.CellContentClick
