...
Public Class frmMainMenu
    ...
    Public Sub RecargarDatos(dgv As DataGridView, Optional sentencia As String = "")
        ...
        Select Case dgv.Name
            ...
            Case "dgvReservas"
                conexion.RellenarDataGridView(dgvReservas, "SELECT R.fechareservainicio, R.idreserva, T.nombre tipo, C.nombre || C.apellido nombreapellido, ca.nombre categoria, R.fechareservafin, R.cantidadkm, R.costototal, R.fechatramite, R.estado, R.idpersona, R.idcategoria, R.idtipo, R.idsucursalsalida, R.idsucursalllegada, SS.nombre salida, SL.nombre llegada, R.usuarioempleado FROM Reserva R, Cliente C, Categoria Ca, Tipo T, Sucursal SS, Sucursal SL WHERE C.idpersona = R.idpersona AND Ca.idcategoria = R.idcategoria AND T.idtipo = R.idtipo AND SS.idsucursal = R.idsucursalsalida AND SL.idsucursal = R.idsucursalllegada")
